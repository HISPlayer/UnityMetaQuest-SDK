...
## RenderTexture & Material Render Mode
If you use **RenderTexture** or **Material** Render Mode in HISPlayer multistream properties, please attach **HISPlayerStereoscopicShader** shader to your Material. Set the 3D Layout option to **Left Right** or **Top Bottom** depending on your stereoscopic video format.
